(function () {
  ...
  var $body = document.querySelector(".contain-intro");
  ...
  window.addEventListener("load", function () {
    window.setTimeout(function () {
      $body.classList.remove("is-preload1");
    }, 100);
  });
  ...
  (function () {
    ...
    var settings = {
      ...
      images: {
        "images/eventually/bg1.jpg": "center",
        "images/eventually/bg2.jpg": "center",
        "images/eventually/bg3.jpg": "center",
      },
  ...
  (function () {
    // Vars.
    var $form = document.querySelectorAll("#signup-form1")[0],
      $submit = document.querySelectorAll("#signup-form1 #submit-btn")[0],
      $message;
